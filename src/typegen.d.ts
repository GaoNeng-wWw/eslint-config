...
export type ConfigNames = 'ignore' | 'gaonengwww/javascript/setup' | 'gaonengwww/javascript/rules' | 'typescript/setup' | 'typescript/parser' | 'typescript/rules' | 'gaonengwww/stylistic'
